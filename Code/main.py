...
class Game:
    ...
    # Display player's lives in the topleft
    ...
    # the player has laser so it has speed to shoot
    def laser_timer(self):
        if pygame.time.get_ticks() - self.shoot_time >= 500:
            self.can_shoot = True

    # the player crash the block
